...
export default function Carousel({ cards }: { cards: CardData[] }) {
  ...
  return (
    <section className="w-full flex-col items-center justify-center overflow-hidden font-sans">
      <div
      ...
      >
        <div className="relative flex w-full flex-col rounded-3xl p-4 pt-6 md:p-6">
          <div className="relative flex h-[280px] w-full items-center justify-center overflow-hidden pt-12 md:h-[400px]">
            <motion.div
          ...
          <div className="mt-6 flex items-center justify-center gap-6">
            <button
              ...
              className="rounded-full border border-gray-300 bg-gray-100 p-2 text-gray-700 transition-colors hover:bg-gray-200 focus:ring-2 focus:ring-green-500 focus:outline-none dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
            >
              ...
              {cardData.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 focus:outline-none ${
                    activeIndex === index
                      ? "w-6 bg-green-400"
                      : "w-2 bg-gray-300 hover:bg-gray-400 dark:bg-neutral-600 dark:hover:bg-neutral-500"
                  }`}
...
function Card({ card, index, activeIndex, totalCards }: CardProps) {
  ...
  return (
    <motion.div
      className="absolute h-[95%] w-1/2 md:w-1/3"
      style={{
