        ...
        <div className="border-default-400 flex h-full flex-1 items-center justify-center rounded-xl border-2">
          {!nextBirthdayUsers.length ? (
            ...
            <div className="flex flex-col items-stretch justify-end px-2 py-4">
              ...
              <div
                className={`${birthdayCakeCommonClassName} flex h-20 w-2/3 items-end justify-evenly rounded-t-xl border-b-0 border-green-400`}
              >
              ...
              <div
                className={`${birthdayCakeCommonClassName} flex h-24 w-64 items-center justify-evenly rounded-xl border-blue-400 text-3xl sm:w-80`}
              >
