...
export default function Footer() {
  ...
  return (
    <footer className="font-inter relative mt-auto overflow-hidden px-4 pt-4 sm:px-6 lg:px-8">
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-2">
        <LogoComponent />

        <p className="text-center text-xs text-gray-500 dark:text-gray-400">
          &copy; 2025 HNB Inc. Chỉ còn bên trái.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm">
          {socialIcons.map((icon) => (
            <a
              ...
              className="dark:!hover:text-white text-gray-600 transition-colors duration-300 hover:text-gray-900 dark:!text-gray-400"
              href={icon.href}
            >
              {icon.svg}
            </a>
